    ...
    <form id="member-profile" action="<?php echo JRoute::_('index.php?option=com_users&task=profile.save'); ?>" method="post" class="form-validate form-horizontal well" enctype="multipart/form-data">
        ...
        <div class="uk-child-width-1-1 uk-grid-medium" data-uk-grid>
            <?php foreach ($this->form->getFieldsets() as $group => $fieldset) : ?>
                ...
                <?php if (count($fields)) : ?>
                    <div>
                        <fieldset class="uk-margin-remove uk-padding-remove noBorder">
        ...
        <div class="control-group">
            <div class="controls uk-child-width-auto uk-grid-small" data-uk-grid>
                <div>
                    <button type="submit" class="uk-button uk-button-gold uk-box-shadow-small uk-border-pill uk-width-1-1 font validate"><?php echo JText::_('JSUBMIT'); ?></button>
                </div>
                <div>
                    <a class="uk-button uk-button-default uk-box-shadow-small uk-border-pill uk-width-1-1 font validate" href="<?php echo JRoute::_('index.php?option=com_users&view=profile'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
                </div>
