...
?>
<div class="uk-flex uk-flex-center langSwitcher <?php echo $moduleclass_sfx; ?>">
<?php if ($headerText) : ?>
...
<?php else : ?>
	<ul class="uk-padding-remove uk-margin-remove" dir="<?php echo JFactory::getLanguage()->isRtl() ? 'rtl' : 'ltr'; ?>">
	<?php foreach ($list as $language) : ?>
		<?php if (!$language->active) : ?>
			<li>
			<a href="<?php echo htmlspecialchars_decode(htmlspecialchars($language->link, ENT_QUOTES, 'UTF-8'), ENT_NOQUOTES); ?>">
