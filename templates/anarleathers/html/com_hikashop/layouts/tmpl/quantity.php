...
?>
		<div class="hikashop_product_quantity_div hikashop_product_quantity_input_div_select"><?php
			...
			ksort($values);
			echo JHTML::_('select.genericlist', $values, '', ' class="uk-select font no-chzn" onchange="var el = document.getElementById(\''.$id.'\'); el.value = this.value; el.onchange();"', 'value', 'text', $current_quantity, $id.'_select');
			?>
