...
?>
<?php if(empty($this->user_id)) return; ?>
...
<div id="hikashop_address_listing">
    ...
    <div id="hikashop_user_addresses_default">
        ...
        <dl class="hikashop_default_billing_address uk-hidden">
        ...
        <dl class="hikashop_default_shipping_address uk-margin-remove">
            <dt><label class="uk-display-block uk-margin-small-bottom uk-form-label uk-text-tiny font" for="hikashop_default_shipping_address_selector"><?php echo JText::_('HIKASHOP_SELECT_DEFAULT_SHIPPING_ADDRESS'); ?></label></dt>
            <dd>
                <?php
                $current = 0;
                $values = array();
                ...
                if(empty($values))
                    $values = array(JHTML::_('select.option', '', JText::_('HIKA_NO_ADDRESS')));
                echo JHTML::_('select.genericlist', $values, 'data[user][default_shipping]', 'class="uk-select uk-width-1-1 uk-border-pill font hikashop_default_address_dropdown" onchange="window.addressMgr.setDefault(this, \'shipping\');"', 'value', 'text', $current, 'hikashop_default_shipping_address_selector');
                ?>
            </dd>
        </dl>
    </div>
...
?>
<div>
	<div class="hikashop_billing_addresses uk-hidden">
