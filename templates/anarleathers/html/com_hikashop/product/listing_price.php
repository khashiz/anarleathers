...
<?php
$fieldClass2 = hikashop_get('class.field');
$field2 = $fieldClass2->getField('coors', 'product');
?>
...
?>
<div class="uk-flex uk-flex-middle uk-position-bottom-left uk-margin-bottom uk-margin-medium-left">
    <?php $colors = explode(',', $fieldClass2->show($field2, $this->row->coors)); ?>
    <ul class="uk-grid-collapse colorsList" data-uk-grid>
        <?php for ($c=0; $c < count($colors); $c++) { ?>
            <?php echo '<li class="uk-flex uk-flex-middle"><span class="listingColors '.$colors[$c].'"></span></li>'; ?>
        <?php } ?>
    </ul>
    <span class="uk-display-block uk-text-center font fnum hikashop_product_price_full <?php echo $class; ?>">
        <?php
    ...
    <span class="uk-text-small font hikashop_product_price_full uk-margin-right"><?php echo $this->row->product_name; ?></span>
</div>
