...
?>
    <div id="hikashop_product_image<?php echo $variant_main;?>" class="hikashop_global_image_div" style="<?php echo $display_mode;?>">
        <!-- MAIN IMAGE -->
        <div id="hikashop_main_image_div<?php echo $variant_name;?>" class="hikashop_main_image_div uk-hidden">
            <?php
        ...
        <div id="hikashop_small_image_div<?php echo $variant_name;?>" class="thumbsWrapper" data-uk-lightbox="animation: slide">
            ...
            if( !empty($this->element->images) && count($this->element->images) > 1) {
                ...
                foreach($this->element->images as $key => $image) {
                    ...
                    $thumbnail_class = 'uk-display-block uk-background-white uk-text-center hikashop_thumbnail_'.$key;
                    if($firstThunb) {
