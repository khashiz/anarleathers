...
?>
	<span class="uk-display-block uk-margin-remove uk-text-large uk-text-lightBrown uk-text-left font f600 fnum <?php echo $class; ?>"><?php
	...
	if(empty($this->row->prices)) {
		...
		foreach($this->row->prices as $k => $price) {
			...
			$classes = array('hikashop_product_price prince_'.$i);
