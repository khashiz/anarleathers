...
<!-- EO CONTINUE SHOPPING BUTTON -->
	...
	<div>
<!-- NEXT BUTTON -->
		<button id="hikabtn_checkout_next" type="submit" class="uk-button uk-button-gold uk-border-pill uk-width-1-1 uk-button-large f600 font" onclick="return window.checkout.submitStep(this);"><?php
