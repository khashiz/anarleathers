...
if($address_selector == 2) {
	...
	echo JHTML::_('select.genericlist', $values, 'hikashop_address_'.$this->type, 'class="uk-select uk-width-1-1 font hikashop_field_dropdown" onchange="window.localPage.switchAddr(this, \''.$this->type.'\','.(int)$current.');"', 'value', 'text', $current, 'hikashop_checkout_address_'.$this->type.'_selector');
