...
if(!$this->module){
	...
	if(($this->params->get('show_image') && !empty($this->element->file_path))|| ($this->params->get('show_description')&&!empty($this->element->category_description))){
		?>
		<div class="hikashop_category_description">ffff
		<?php
		if($this->params->get('show_image') && !empty($this->element->file_path)){
			...
			?>
                rfrefrferfrefefrefrfe
			<img yyyy src="<?php echo $this->image->getPath($this->element->file_path); ?>" class="hikashop_category_image" title="<?php echo $this->escape(@$this->element->file_description); ?>" alt="<?php echo $this->escape(@$this->element->file_name); ?>"/>
			<?php
			}
		}
